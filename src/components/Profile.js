...
export default function Profile() {
  ...
  return (
    <>
        <Nav/>
        {!showEditProfile && <div className="pt-10 grid place-items-center">
          <div className="p-3 md:max-w-5xl bg-slate-100 rounded-lg border border-slate-500 shadow-lg items-center ">
            ...
            <div className="border-t border-gray-200">
              ...
              <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                  ...
                  <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2 flex items-center justify-center">
                    {updatedPhoto ? <img className="h-40 w-40 " src={ updatedPhoto } alt="" />:<img className="h-40 w-40 " disabled={activeUser.photo === ''} src={ activeUser.photo } alt="" />}
            ...
            <div className="pt-2">
                    <button onClick={() => {setShowEditProfile(true)}} className="inline-flex justify-center w-full py-2 px-4 border border-transparent shadow-sm text-med font-medium rounded-md text-white bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-900">
                      Edit
                    </button>
                    </div>
          </div>
